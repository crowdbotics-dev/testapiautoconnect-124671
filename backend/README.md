...
## Project Structure
    ...
    ├── testapiautoconnect_124671  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_124671`
...
2. Clone this repo and `cd testapiautoconnect_124671`
